class EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(:name, :start_day, :end_day, :work_start_time, :work_end_time, :prefecture_id, :address, :daily_wage, :detail, :position_id, :assign_num, :place_name, :event_status_id).merge(owner_id: current_user.id)
  end
